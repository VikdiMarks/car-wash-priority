...
export default function ModalWindow({ trigger, setTrigger, title, children }) {
					...
					<div
						...
						<div
							...
							<div
								...
								<h6
									className={
										"text-black-100 text-2xl font-semibold text-center"
									}>
									{title}
								</h6>
								<p
									className={
										"text-black/40 text-sm text-center"
									}>
									{children[0]}
								</p>
							</div>
